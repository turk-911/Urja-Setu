...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-between rounded-md px-6 py-6 text-muted-foreground w-[100%]",
      className
    )}
    {...props}
  />
